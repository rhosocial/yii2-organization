...
/**
 * Class NumberOfDepartmentsExceededException
 * @package rhosocial\organization\exceptions
 * @version 1.0
 * @author vistart <i@vistart.me>
 */
class NumberOfDepartmentsExceededException extends UnauthorizedHttpException
{
    /**
     * Constructor.
    ...
    {
        return 'NumberOfDepartmentsExceededException';
    }
}
